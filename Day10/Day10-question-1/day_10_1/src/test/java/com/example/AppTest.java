...
public class AppTest 
{
   ...
   void beforeit()
   {
    PropertyConfigurator.configure("D:\\SEllinium\\Class work\\Day10\\Day10-question-1\\day_10_1\\src\\main\\java\\com\\example\\log4j.properties");
    ...
    logger.info("going to website moneycontrol");
    }
    @Test
    ...
    Thread.sleep(3000);
    logger.warn("Waiting for web to load");
    }
    @Test
    void Test3()
    {
    ...
    logger.info("checking the website contains 'Reliance Industries Ltd'");
    }
    @Test
...
void Test5() throws InterruptedException
{
    ...
    void finaltest()
    {
        ...
        logger.info("Printing the output");
    }
}
